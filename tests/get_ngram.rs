    ...
    assert_eq!(
        ...
        Ngram {
            ...
            stats: vec![
                ...
                NgramStat::new(1949, 1, 1.1013769794641905e-10),
                NgramStat::new(1953, 1, 1.1258132161048287e-10),
                NgramStat::new(1955, 1, 1.0437787704048938e-10),
                NgramStat::new(1961, 3, 2.3776660155197906e-10),
                ...
                NgramStat::new(1966, 6, 3.958724990711243e-10),
                ...
                NgramStat::new(1999, 215, 9.033388569417679e-9),
                ...
                NgramStat::new(2006, 443, 1.524138429704294e-8),
                NgramStat::new(2007, 499, 1.6795417030071738e-8),
                NgramStat::new(2008, 660, 2.186822240305688e-8),
                NgramStat::new(2009, 644, 2.2091717619467e-8),
                NgramStat::new(2010, 653, 2.3353041213841277e-8),
                NgramStat::new(2011, 879, 3.095878049256371e-8),
                NgramStat::new(2012, 743, 2.052784462134313e-8),
                NgramStat::new(2013, 882, 2.40630330285879e-8),
                NgramStat::new(2014, 779, 2.4044848043877065e-8),
                NgramStat::new(2015, 784, 2.785195650022064e-8),
                NgramStat::new(2016, 1021, 3.638333794599344e-8),
                NgramStat::new(2017, 1109, 3.83446189706865e-8),
                NgramStat::new(2018, 1231, 4.451453958825237e-8),
                NgramStat::new(2019, 838, 3.4897799608984645e-8),
            ],
        }
    )
}
